...
setwd("C:\\Users\\s\\Downloads\\Data-Science")
...
recommendation_system$IBCF_realRatingMatrix$paramenters
...
for(index in 1:10){
  movie_user2[index]<-as.character(subset(movie_data,movie_data$movieId==movie_user1[index])$title)
}
movie_user2
